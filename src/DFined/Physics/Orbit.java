...
public class Orbit {
    ...
    public void draw(PApplet applet){
        if(anchor != null) {
            applet.rotateZ((float) (yawOffset+Math.PI));
            applet.translate((float) (this.focus/Physics.DISTANCE_SCALE), 0, 0);
            applet.ellipse(0, 0, (float) this.semiMajor/Physics.DISTANCE_SCALE*2, (float) this.semiMinor/Physics.DISTANCE_SCALE*2);
        }
    }
